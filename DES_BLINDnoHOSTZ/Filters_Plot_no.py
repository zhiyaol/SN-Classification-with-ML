...
g = ascii.read('DES_BLINDnoHOSTZ/DES_g.dat')
g_W = g['col1']
g_P = g['col2']

r = ascii.read('DES_BLINDnoHOSTZ/DES_r.dat')
r_W = r['col1']
r_P = r['col2']

i = ascii.read('DES_BLINDnoHOSTZ/DES_i.dat')
i_W = i['col1']
i_P = i['col2']

z = ascii.read('DES_BLINDnoHOSTZ/DES_z.dat')
z_W = z['col1']
z_P = z['col2']
