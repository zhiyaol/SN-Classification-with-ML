...
SN_list = ascii.read('no_Type-9_List.dat') #adjust for other types

import matplotlib.backends.backend_pdf
import random

out_pdf = r'no_Type-9_Plots.pdf' #adjust for other types
...
while i<60: #adjust for other types
    ...
    for x in range(6):
        ...
        t = rdr.read('DES_BLINDnoHOSTZ/' + SN_list['-9 List'][index]) #adjust for other types
        ...
        plt.title('%s no host-galaxy photo-z; SNTYPE: -9' % SN_list['-9 List'][index]) #adjust for other types
